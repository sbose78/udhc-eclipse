		...
		<td id="lc"> 
		 ...
		 <div class ="user_type_div"> We shall share your data with your consent    </div>
   			 ...
   			 <div class="user_instruction" align="center">
                       ...
                       <a href="<%=request.getContextPath()%>/STATICS/docs/udhc-hindi.pdf">Letter of consent - Hindi</a> &nbsp;
                       <a href="<%=request.getContextPath()%>/STATICS/docs/udhc-bengali.pdf">Letter of consent - Bengali</a>&nbsp;
                       <a href="<%=request.getContextPath()%>/STATICS/docs/udhc-english.pdf">Letter of consent - English</a>&nbsp;
