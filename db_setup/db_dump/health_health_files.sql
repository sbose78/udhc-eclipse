...
--
-- Table structure for table `health_files`
--

DROP TABLE IF EXISTS `health_files`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `health_files` (
  `idhealth_files` int(11) NOT NULL AUTO_INCREMENT,
  `file` longblob,
...
-- Dump completed on 2013-06-19  0:30:08
